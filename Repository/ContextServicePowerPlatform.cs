...
{
    public class ContextServicePowerPlatform : IContextServicePowerPlatform
    {
        #region Properties
        ...
        public ContextServicePowerPlatform(string nameServices, Guid userId, ServiceClient serviceClient, string connectedOrgFriendlyName, CrmServiceClient crmServiceClient, string powerPlatformUrl)
        {
