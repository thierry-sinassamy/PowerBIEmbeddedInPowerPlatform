...
{
    public abstract class DataverseRepository<T> : IRepository<T> where T : Entity
    {
        protected ServiceClient ServiceClientDataverse { get; set; }
        protected CrmServiceClient CrmServiceClientDataverse { get; set; }

        protected DataverseRepository(IContextServicePowerPlatform context)
        {
        ...
        public virtual void Execute(PublishXmlRequest publishXmlRequest)
        {
            throw new NotImplementedException();
        }
